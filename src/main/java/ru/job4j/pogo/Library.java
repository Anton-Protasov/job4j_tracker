...
public class Library {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < library.length; i++) {
            ...
            System.out.println("Название книги: " + bookcase.getName() + " страниц: " + bookcase.getPages());
        }
        System.out.println();
        ...
        for (int i = 0; i < library.length; i++) {
            ...
            if ("Clean code".equals(bookcase.getName())) {
                System.out.println("Книга найдена: " + bookcase.getName() + " страниц: " + bookcase.getPages());
            }
        }
    }
}
