...
Игра заканчивается, когда игрок забрал последние спички. В цикле нужно проверять количество спичек.
Сделайте ввод данных от пользователя. Сначала первый игрок вводит число от 1 до 3, потом второй и так далее.
